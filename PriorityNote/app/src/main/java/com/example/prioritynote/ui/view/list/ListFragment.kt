...
class ListFragment : Fragment(),SearchView.OnQueryTextListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId  ) {
             ...
             R.id.menu_priority_high -> priorityNoteViewModel.sortByHighPriority.observe(this, Observer { adapter.setData(it) })
             R.id.menu_priority_low -> priorityNoteViewModel.sortByLowPriority.observe(this, Observer { adapter.setData(it) })
        }
    ...
    private fun searchItemInDatabase(query: String) {
       var searchQuery = query
        ...
        priorityNoteViewModel.searchDatabase(searchQuery).observe(this, Observer { list ->
